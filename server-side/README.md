...
There is a single controller in the `com.quicknotes.controller` package called `AuthenticationController.java`.
...
`com.quicknotes.dao.FinalCapstoneDaoTests` has been provided for you to use as a base class for any DAO integration test. It initializes a Datasource for testing and manages rollback of database changes between tests.
